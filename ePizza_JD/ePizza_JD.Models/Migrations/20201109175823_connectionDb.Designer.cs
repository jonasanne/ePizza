...
namespace ePizza_JD.Models.Migrations
{
    ...
    [Migration("20201109175823_connectionDb")]
            ...
            modelBuilder.Entity("ePizza_JD.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            OrderId = new Guid("e68a3f79-ba5a-49f3-95c7-5e38298e7fde"),
                            Date = new DateTime(2020, 11, 9, 18, 58, 22, 824, DateTimeKind.Local).AddTicks(5144),
                            OrderType = 1,
                        ...
                        {
                            OrderId = new Guid("bba2eded-d219-4618-b0ce-c3a983772772"),
                            Date = new DateTime(2020, 11, 9, 18, 58, 22, 828, DateTimeKind.Local).AddTicks(2030),
                            OrderType = 0,
            ...
            modelBuilder.Entity("ePizza_JD.Models.Pizza", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            PizzaId = new Guid("c79c0a93-09b0-433b-b19b-7e129ef39a24"),
                        ...
                        new
                        {
                            PizzaId = new Guid("5ae266d0-558e-4345-87cd-77b5811b2b0d"),
                        ...
                        new
                        {
                            PizzaId = new Guid("ec51a69a-8572-4968-9878-08739eac738e"),
                        ...
                        new
                        {
                            PizzaId = new Guid("d8e6877b-98bc-4a69-ab23-e3dd76e7a2ff"),
                        ...
                        new
                        {
                            PizzaId = new Guid("1ed1de5b-0bbf-432b-b34f-a249e7a51200"),
                        ...
                        new
                        {
                            PizzaId = new Guid("26cfe7f5-c67c-4a04-99da-33c0ab68558a"),
                        ...
                        new
                        {
                            PizzaId = new Guid("cbb0c4ac-c9d9-496c-834f-f473db1921ac"),
                        ...
                        new
                        {
                            PizzaId = new Guid("efa7b3d7-7df4-4295-ab36-c80e80ce4095"),
            ...
            modelBuilder.Entity("ePizza_JD.Models.Restaurant", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RestaurantId = new Guid("b50951e5-0790-46b7-bc15-413fdcaca7b5"),
                            City = "Brugge",
                            HouseNumber = 160,
                        ...
                        new
                        {
                            RestaurantId = new Guid("30ea1ba0-fbdd-44ff-a487-1f835afc0134"),
                            City = "Ieper",
                            HouseNumber = 351,
                        ...
                        new
                        {
                            RestaurantId = new Guid("905fd5bc-cd89-4862-817e-a73d80c9330b"),
                            City = "Antwerpen",
                            HouseNumber = 399,
            ...
            modelBuilder.Entity("ePizza_JD.Models.Review", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ReviewId = new Guid("c456b9e8-d32c-4d6e-8b32-da50c5edc856"),
                            Date = new DateTime(2020, 11, 9, 18, 58, 22, 828, DateTimeKind.Local).AddTicks(3901),
                            Rating = 4.0,
                            Title = "Amazing pizza!"
                        },
                        new
                        {
                            ReviewId = new Guid("0eae9dca-640f-408e-8aa5-325f40cb3eee"),
                            Date = new DateTime(2020, 11, 9, 18, 58, 22, 828, DateTimeKind.Local).AddTicks(5410),
            ...
            modelBuilder.Entity("ePizza_JD.Models.Topping", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ToppingId = new Guid("487283fe-19bc-4d2a-a307-670dc3330a3c"),
                            Name = "Ham",
                            Price = 1.3999999999999999
                        },
                        new
                        {
                            ToppingId = new Guid("1642d747-bc19-4084-a898-9b39b25002c6"),
                            Name = "Mozzarella",
                            Price = 1.3999999999999999
                        },
                        new
                        {
                            ToppingId = new Guid("87fda82d-a1da-4b67-a530-fa9fb8d0f5ea"),
                            Name = "Pepperoni",
                            Price = 1.3999999999999999
                        },
                        new
                        {
                            ToppingId = new Guid("3cd57dfa-372a-4683-a5a2-7732bb29b062"),
                            Name = "Champignons",
                            Price = 1.3999999999999999
                        },
                        new
                        {
                            ToppingId = new Guid("fdce7470-88b6-444f-868f-0fc61f4ed027"),
                            Name = "Pineapple",
                            Price = 1.3999999999999999
                        },
                        new
                        {
                            ToppingId = new Guid("138c6493-d2fd-4e9e-9fdc-e44b92cbb12e"),
                            Name = "Chilipepper",
                            Price = 1.3999999999999999
                        },
                        new
                        {
                            ToppingId = new Guid("22ed4bce-ee33-40b0-9f4c-050cdfc9c799"),
                            Name = "Red onion",
                            Price = 1.3999999999999999
                        },
                        new
                        {
                            ToppingId = new Guid("d27997ab-b174-48d8-b3a8-3fc8c0cfcce6"),
                            Name = "Grilled Chicken",
                            Price = 1.3999999999999999
                        },
                        new
                        {
                            ToppingId = new Guid("b8215916-922a-4c84-989e-ceec6a29a095"),
                            Name = "Barbecue sauce",
                            Price = 1.3999999999999999
                        },
                        new
                        ...
                        new
                        {
                            ToppingId = new Guid("67803285-4117-43f1-afa6-fc7c5db54186"),
                            Name = "Pork",
                            Price = 1.3999999999999999
                        },
                        new
                        ...
                        new
                        {
                            ToppingId = new Guid("4a4cfb2e-42dc-434f-942c-7d66d241bb05"),
                            Name = "Goat cheese",
                            Price = 1.3999999999999999
                        },
                        new
                        {
                            ToppingId = new Guid("3724ce66-c091-4fcc-aa16-179bb4ad286a"),
                            Name = "Gorgonzola",
                            Price = 1.3999999999999999
                        },
                        new
                        {
                            ToppingId = new Guid("8d17630a-15ac-4d6a-ab71-4d655b9d9dda"),
                            Name = "Paprika",
                            Price = 1.3999999999999999
                        });
                });
